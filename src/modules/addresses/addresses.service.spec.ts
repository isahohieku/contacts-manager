...
describe('AddressesService', () => {
  ...
  describe('create', () => {
    ...
    it('should throw error when contact is not found', async () => {
      ...
      await expect(
        service.create(mockUser as unknown as User, createAddressDto),
  ...
  describe('findOne', () => {
    ...
    it('should return address when found', async () => {
      ...
      expect(mockAddressRepository.createQueryBuilder).toHaveBeenCalledWith(
        'address',
      );
      ...
      expect(queryBuilder.where).toHaveBeenCalledWith('address.id = :id', {
        id: addressId,
      });
    ...
    it('should throw error when address not found', async () => {
      ...
      await expect(
        service.findOne(mockUser as unknown as User, addressId),
      ).rejects.toThrow(mockError);
  ...
  describe('update', () => {
    ...
    it('should update address successfully', async () => {
      ...
      mockAddressRepository.create.mockReturnValue({
        id: addressId,
        ...updateAddressDto,
      });
  ...
  describe('remove', () => {
    ...
    it('should throw error when address not found for removal', async () => {
      ...
      await expect(
        service.remove(mockUser as unknown as User, addressId),
      ).rejects.toThrow(mockError);
