...
export class AddressCountry1719554747999 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "address" RENAME COLUMN "country" TO "countryId"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "address" DROP COLUMN "countryId"`);
    await queryRunner.query(
      `ALTER TABLE "address" ADD "countryId" character varying(50)`,
    );
    await queryRunner.query(
      `ALTER TABLE "address" RENAME COLUMN "countryId" TO "country"`,
    );
  }
}
