...
export class ModifiedRelations1718462104433 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "email" ADD CONSTRAINT "FK_6614e4b90cf4ff091c2fbf51269" FOREIGN KEY ("emailTypeId") REFERENCES "email_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "email" DROP CONSTRAINT "FK_6614e4b90cf4ff091c2fbf51269"`,
    );
