...
export class AuthContact1706943657752 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "contact" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" SERIAL NOT NULL, "email" character varying, "password" character varying, "firstName" character varying(45) NOT NULL, "lastName" character varying(45), "organization" character varying(100), "job_title" character varying(100), "birthday" date, "anniversary" date, "avatar" character varying(100), "notes" text, "ownerId" integer, CONSTRAINT "UQ_eff09bb429f175523787f46003b" UNIQUE ("email"), CONSTRAINT "PK_2cbbe00f59ab6b3bb5b8d19f989" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_098b27a757ea3de61f67cdfddd" ON "contact" ("firstName") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0d1e9990415a51a5c459dc0bb3" ON "contact" ("lastName") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_06fb84db5e57c39d3928f18d6e" ON "contact" ("organization") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c59af2def01d8d8d8645bdf5b3" ON "contact" ("job_title") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "contact" ADD CONSTRAINT "FK_68cfe567915dcb767204eba5895" FOREIGN KEY ("ownerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "contact" DROP CONSTRAINT "FK_68cfe567915dcb767204eba5895"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c59af2def01d8d8d8645bdf5b3"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_06fb84db5e57c39d3928f18d6e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0d1e9990415a51a5c459dc0bb3"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_098b27a757ea3de61f67cdfddd"`,
    );
